...
public class MessageServiceLocator extends org.apache.axis.client.Service implements cn.mldn.remote.service.impl.MessageService {
    ...
    public cn.mldn.remote.service.IMessageService getMessageServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public cn.mldn.remote.service.IMessageService getMessageServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.mldn.remote.service.impl.MessageServiceImplPortBindingStub _stub = new cn.mldn.remote.service.impl.MessageServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.mldn.remote.service.IMessageService.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.mldn.remote.service.impl.MessageServiceImplPortBindingStub _stub = new cn.mldn.remote.service.impl.MessageServiceImplPortBindingStub(new java.net.URL(MessageServiceImplPort_address), this);
                _stub.setPortName(getMessageServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.remote.mldn.cn/", "messageService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.remote.mldn.cn/", "MessageServiceImplPort"));
        }
