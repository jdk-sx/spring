...
public class IMessageServiceProxy implements cn.mldn.remote.service.IMessageService {
  private String _endpoint = null;
  private cn.mldn.remote.service.IMessageService iMessageService = null;
  ...
  private void _initIMessageServiceProxy() {
    try {
      iMessageService = (new cn.mldn.remote.service.impl.MessageServiceLocator()).getMessageServiceImplPort();
  ...
  public cn.mldn.remote.service.IMessageService getIMessageService() {
    if (iMessageService == null)
      _initIMessageServiceProxy();
